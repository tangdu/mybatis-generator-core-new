 ...
 *
 */
public class BatDeleteByPrimaryKeyMethodGenerator extends AbstractJavaMapperMethodGenerator {

    private boolean isSimple;

    public BatDeleteByPrimaryKeyMethodGenerator(boolean isSimple) {
        super();
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(introspectedTable.getBatDeleteByPrimaryKeyStatementId());
        ...
        addMethodComment(method, "根据ID批量删除" + getTableRemark() + "信息", method.getParameters().get(0).getName(), getTableRemark() + "删除对象", "影响行");
