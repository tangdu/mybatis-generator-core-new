 ...
 * @author Jeff Butler
 */
public class Delete2ByPrimaryKeyElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        FullyQualifiedJavaType uptDOType = new FullyQualifiedJavaType(pojoUrl + "." + tableName);

        answer.addAttribute(new Attribute("id", introspectedTable.getDelete2ByPrimaryKeyStatementId())); //$NON-NLS-1$
