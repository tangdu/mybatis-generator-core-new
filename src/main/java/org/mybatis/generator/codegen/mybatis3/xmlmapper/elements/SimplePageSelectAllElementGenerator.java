 ...
 *
 */
public class SimplePageSelectAllElementGenerator extends AbstractXmlElementGenerator {

    public SimplePageSelectAllElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", introspectedTable.getPageSelectAllStatementId())); //$NON-NLS-1$
