 ...
 *
 */
public class Delete2ByPrimaryKeyMethodGenerator extends AbstractJavaMapperMethodGenerator {
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        addMethodComment(method, "根据ID删除" + getTableRemark() + "信息", method.getParameters().get(0).getName(), getTableRemark() + "删除对象", "影响行");
