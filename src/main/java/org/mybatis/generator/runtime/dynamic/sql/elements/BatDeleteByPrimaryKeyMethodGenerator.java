...
public class BatDeleteByPrimaryKeyMethodGenerator extends AbstractMethodGenerator {

    private String tableFieldName;
    private FragmentGenerator fragmentGenerator;

    private BatDeleteByPrimaryKeyMethodGenerator(Builder builder) {
        super(builder);
    ...
    public static class Builder extends BaseBuilder<Builder, BatDeleteByPrimaryKeyMethodGenerator> {
        ...
        @Override
        public BatDeleteByPrimaryKeyMethodGenerator build() {
            return new BatDeleteByPrimaryKeyMethodGenerator(this);
        }
    }
}
